...
},{"bootstrap":"6Rnl7","./main.css":"4MECU","bootstrap/dist/css/bootstrap.min.css":"25uA3"}],"6Rnl7":[function(require,module,exports) {
...
const allowedAttribute = (attribute, allowedAttributeList)=>{
    ...
    for(let i1 = 0, len1 = regExp.length; i1 < len1; i1++){
        if (regExp[i1].test(attributeName)) return true;
    }
    return false;
};
...
function sanitizeHtml(unsafeHtml, allowList, sanitizeFn) {
    ...
    for(let i1 = 0, len1 = elements.length; i1 < len1; i1++){
        const element7 = elements[i1];
        const elementName = element7.nodeName.toLowerCase();
        if (!Object.keys(allowList).includes(elementName)) {
            element7.remove();
            continue;
        }
        const attributeList = [].concat(...element7.attributes);
        const allowedAttributes = [].concat(allowList['*'] || [], allowList[elementName] || []);
        attributeList.forEach((attribute)=>{
            if (!allowedAttribute(attribute, allowedAttributes)) element7.removeAttribute(attribute.nodeName);
        });
    }
...
},{"./createPopper.js":"eWRl5","./modifiers/eventListeners.js":"gK2qK","./modifiers/popperOffsets.js":"767Ci","./modifiers/computeStyles.js":"eNeWb","./modifiers/applyStyles.js":"iCp47","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"4MECU":[function() {},{}],"25uA3":[function() {},{}]},["8Ye98","6cF5V"], "6cF5V", "parcelRequire9b47")
